...
namespace SignInScreen.Forms
{
    partial class FormOverview
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Computer Care";
            ...
            this.label2.Text = "A local computer reseller provides flyers on computer care to its customers. You " +
    "work as a technician for this store and have been tasked to prepare a new flyer." +
    "";
